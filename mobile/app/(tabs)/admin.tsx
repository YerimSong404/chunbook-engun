...
const styles = StyleSheet.create({
    ...
    card: { backgroundColor: '#FFFFFF', borderRadius: 20, padding: 24, marginBottom: 24, elevation: 4, shadowColor: '#3A3125', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.04, shadowRadius: 12 },
    editCard: {
        backgroundColor: '#FCFAF5', borderRadius: 20, padding: 24, marginBottom: 32,
        borderWidth: 1, borderColor: '#D4C8B8',
    },
    label: { fontSize: 13, fontWeight: '600', color: '#7A7265', marginBottom: 8, letterSpacing: 0.5 },
    input: {
        backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#F0EBE1', borderRadius: 12, padding: 16, fontSize: 15, marginBottom: 20, color: '#2C2724'
    },
    ...
    pickerWrap: { borderWidth: 1, borderColor: '#F0EBE1', borderRadius: 12, marginBottom: 20, overflow: 'hidden', backgroundColor: '#FFFFFF' },
    ...
    btn: { paddingVertical: 16, paddingHorizontal: 24, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
    ...
    emptyCard: { alignItems: 'center', padding: 40, backgroundColor: '#FFFFFF', borderRadius: 20, elevation: 4, shadowColor: '#3A3125', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.04, shadowRadius: 12 },
    ...
    meetingCard: { backgroundColor: '#FFFFFF', borderRadius: 20, padding: 24, marginBottom: 16, elevation: 4, shadowColor: '#3A3125', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.04, shadowRadius: 12 },
    ...
    meetingNumberBadge: { backgroundColor: '#F0EBE1', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 100 },
    ...
    actionBtn: { paddingVertical: 8, paddingHorizontal: 16, borderRadius: 8, backgroundColor: '#F9F6F0' },
    actionBtnText: { color: '#695D4A', fontSize: 13, fontWeight: '600' },
    actionBtnDanger: { paddingVertical: 8, paddingHorizontal: 16, borderRadius: 8, backgroundColor: '#FAFAFA', borderWidth: 1, borderColor: '#EBE5D9' },
    actionBtnDangerText: { color: '#B07D4F', fontSize: 13, fontWeight: '600' },
    cardHeader: { flexDirection: 'row', backgroundColor: '#FFFFFF', borderRadius: 20, padding: 20, marginBottom: 32, elevation: 4, shadowColor: '#3A3125', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.04, shadowRadius: 12 },
    ...
    settingsAlert: { backgroundColor: '#FAEDDF', padding: 16, borderRadius: 12 },

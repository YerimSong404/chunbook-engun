...
const styles = StyleSheet.create({
    ...
    input: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#ddd', borderRadius: 8, padding: 10, fontSize: 14 },
    ...
    // Topics List
    emptyTopicsCard: { backgroundColor: '#f9f9f9', borderRadius: 12, padding: 30, alignItems: 'center' },
    ...
    answerCard: { backgroundColor: '#fff', borderRadius: 16, padding: 20, borderWidth: 1, borderColor: '#eee' },

...
export default function AdminPage() {
    ...
    const removeTopicSlot = (i: number) => {
        if (form.topics.length <= 4) return;
    ...
    const handleEditMeeting = (m: Meeting) => {
        ...
        setForm({
            ...
            status: m.status,
            topics: m.topics.length >= 4 ? m.topics : [...m.topics, ...Array(4 - m.topics.length).fill('')],
    ...
    return (
        <AppShell>
            ...
            {tab === 'meetings' && (
                <>
                    <div className="section-title">{editId ? '모임 수정' : '새 모임 등록'}</div>
                    <div className="card" style={{ marginBottom: 24 }}>
                        ...
                        <div className="form-group">
                            ...
                            <input
                                ...
                                type="number"
                                min={1}
                                placeholder={editId ? '번호 입력' : `자동 입력 (제${nextMeetingNumber}회)`}
                        ...
                        <div className="form-group">
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                                <label className="form-label" style={{ margin: 0 }}>발제 주제 ({form.topics.length}/6)</label>
                                {form.topics.length < 6 && (
